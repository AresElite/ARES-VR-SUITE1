...
/* FocusFrenzy retired — replaced by the full 100-level survival port in execute/FocusFrenzyVR.ts */
...
/* SaccadeSwipe retired — replaced by the full 100-level port in execute/SaccadeSwipeVR.ts */
